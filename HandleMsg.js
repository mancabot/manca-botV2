...
moment.tz.setDefault('Asia/Jakarta').locale('id')
	...
	const waver = await aruga.getWAVersion()
        ...
        // [IDENTIFY]
        const ownerNumber = "6283815956151@c.us"
...
// FUNCTION
      ...
      if (chats == 'Bang'){
          aruga.reply(from, 'Ada apa bro?', id)
		  }
      if (chats == 'bang'){
          aruga.reply(from, 'Ada apaan Bro?', id)
		  }
      if (chats == 'Om'){
          aruga.reply(from, 'Ada apaan sih, panggil om-om', id)
		  }
      if (chats == 'om'){
          aruga.reply(from, 'Ada apaan sih, panggil om-om', id)
		  }
      if (chats == 'Ok'){
          aruga.reply(from, 'Iya Sama-Sama Bro..', id)
		  }
      if (chats == 'ok'){
          aruga.reply(from, 'Iya Sama-Sama Bro..', id)
      }
      ...
      if (chats == 'gimana kabarnya'){
          aruga.reply(from, 'Alhamdulillah Aq baik-baik aja ko mas..', id)
      }
      if (chats == 'Mks'){
          aruga.reply(from, 'Iya sama-sama..', id)
      }
     ...
     if (chats == '#rhentai'){
      ...
      if (chats == 'onichan'){
        aruga.sendPtt(from, './media/onichan.mp3', id)
      }
      if (chats == 'sepi'){
        aruga.sendPtt(from, './media/onichan.mp3', id)
      }
      ...
      if (chats == 'ketawa'){
        aruga.sendPtt(from, './media/ketawa.mp3', id)
      }
      if (chats == 'kunti'){
        aruga.sendPtt(from, './media/ketawa.mp3', id)
      }
      if (chats == 'pale'){
        ...
        const cegan = [
            "https://i.ibb.co/b6kQkfJ/IMG-20210121-WA0252.jpg",
            "https://i.ibb.co/Bcg8mFT/IMG-20210201-215828.jpg",
            "https://i.ibb.co/LtvG3rw/IMG-20210117-003821.jpg,
            "https://i.ibb.co/khRgWXH/IMG-20201215-WA0373.jpg",
            "https://i.ibb.co/Bcg8mFT/IMG-20210201-215828.jpg",
            "https://i.ibb.co/RPMvS3B/IMG-20201215-WA0382.jpg"
        ]
        const cecan = [
            {
            lahwoi : "Bini gua yang ke 1",
            imagex : "https://i.ibb.co/PzS7tVk/IMG-20210221-WA0176.jpgg",
            },
            {
            ...
            imagex : "https://i.ibb.co/9cwHBhx/IMG-20210121-WA0250.jpg",
            },
            {
            lahwoi : "Bini gua yang ke 4",   
            imagex : "https://i.ibb.co/zZhbNhF/IMG-20201229-140514-015.jpg",
            },
            {
            ...
            imagex : "https://i.ibb.co/pvQsQQq/IMG-20210104-WA0818.jpg",
            },
            {
            lahwoi : "Bini gua yang ke 8",
            imagex : "https://i.ibb.co/CWgLWpt/IMG-20201205-WA0468.jpg",
            },
            {
            lahwoi : "Bini gua yang terakhir",
            imagex : "https://i.ibb.co/W0dLpYW/IMG-20201230-WA0242.jpg"
            }
        ]
	...
	// Filter Banned People
        ...
        case 'tnc':
            ...
            break
        case 'help':
            const bots = `Hi minna, this is Manca Bot, to find out the commands menu, type *${prefix}menu* , *${prefix}p*`
        ...
        case 'menu':
            ...
            if (nyoba2 == undefined) {
                var php2 = 'https://i.ibb.co/pvQsQQq/IMG-20210104-WA0818.jpg'
                } else {
                var php2 = nyoba2
                }
        ...
        case 'menuadmin':
            ...
            const php4 = 'https://i.ibb.co/pvQsQQq/IMG-20210104-WA0818.jpg'
...
case 'join':
                        ...
                        await aruga.sendText(chekgrup.id, `what up y'all , I'm Manca Bot. To find out the commands on this Bot type ${prefix}menu`)
                    })
					} else {
...
case 'brainly':
            ...
            if (args.length >= 2){
			    ...
			    aruga.sendText(from, 'Selesai ✅, donasi kesini ya paypal.me/NurulCans | Pulsa : 083815956151')
                        } else {
...
case 'distance':
                ...
                break
case 'glitch':
						if (args.length === 0) return aruga.reply(from, `Kirim perintah *${prefix}glitch [ |Teks1|Teks2 ]*, contoh *${prefix}glitch |BOT|Dev NurulCans*`, id)
						argz = body.trim().split('|')
						if (argz.length >= 2) {
                        aruga.reply(from, mess.wait, id)
                        ...
                        await aruga.reply(from, `Wrong Format!\n[❗] Kirim perintah *${prefix}glitch [ |Teks1|Teks2 ]*, contoh *${prefix}glitch |BOT|Dev NurulCans*`, id)
                    }
                break
case 'javcosplay':
						await aruga.reply(from, mess.wait, id)
                            ...
                            case 'asupan':
                                ...
                                rugaapi.asupan()
                                    .then(async (body) => {
                                        ...
                                        await aruga.sendFileFromUrl(from, `http://sansekai.my.id/ptl_repost/${asupanx}`, 'asupan.mp4', 'Follow IG: https://www.instagram.com/thenay_xploit_ untuk mendapatkan asupan lebih banyak.', id)
...
case 'chika'://piyobot
						...
						aruga.sendFileFromUrl(from, `https://piyobot.000webhostapp.com/${chikax}.mp4`, 'chika.mp4', 'Nih Bro Videonya chika...', id)
...
_Desc di update oleh : @${chat.groupMetadata.descOwner.replace('@c.us','')} pada *${moment(chat.groupMetadata.descTime * 1000).format('dddd, DD MMMM YYYY')}* pukul ${moment(chat.groupMetadata.descTime * 1000).format('HH:mm:ss')}_`)
                    ...
                    break
                    case 'grupbot':
                        const ch = `https://chat.whatsapp.com/BZsX9n2stBp0wqUsZslvPe\n\nSkuyy joinn`
                        await aruga.reply(from, ch, id)
                        break
                    case 'mtk':
                        if (args.length === 3) return aruga.reply(from, `[❗] Kirim perintah *${prefix}mtk [ Angka ]*\nContoh : ${prefix}mtk 12 * 12\n*NOTE* :\n- Untuk Perkalian Menggunakan *\n- Untuk Pertambahan Menggunakan +\n- Untuk Pengurangan Mennggunakan -\n- Untuk Pembagian Menggunakan /`)
                        const mtk = body.slice(5)
                        if (typeof Math_js.evaluate(mtk) !== "number") {
                        aruga.reply(from, `"${mtk}", bukan angka!\n[❗] Kirim perintah *${prefix}mtk [ Angka ]*\nContoh : ${prefix}mtk 12 * 12\n*NOTE* :\n- Untuk Perkalian Menggunakan *\n- Untuk Pertambahan Menggunakan +\n- Untuk Pengurangan Mennggunakan -\n- Untuk Pembagian Menggunakan /`, id)
                    } else {
                    ...
                    case 'screen': {
                        ...
                        break
                        case 'addbacot':{
                            if (!args.length >= 1) return aruga.reply(from, 'BACOTAN NYA MANA COEGS?? DASAR SOK KERAS KAU!', id)  
...
case 'aiquote' :
                         ...
                         await aruga.sendFileFromUrl(from, aiquote.data, 'quote.jpg', 'FOLLOW NGAB \ :V https://www.instagram.com/thenay_xploit_/' , id )
                break
case 'ttp':
